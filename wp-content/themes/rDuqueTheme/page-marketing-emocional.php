							...
							<div class="card">	
								<div class="card-body">
									<div class="media">
									  ...
									  <div class="media-body">
											<a href="http://rduque.com/video-marketing/" title="Empezar a crear mi vídeo promocional" class="nav-link">
									    	<h2>Video Marketing</h2>
											</a>
									    <p class="ml-3">Nada tiene más alcance ni vende mejor que un buen vídeo</p>
									  </div>
									</div>
								</div>

								<div class="card-footer text-right">
							    <a href="http://rduque.com/video-marketing/" title="Clic aquí para comenzar" class="btn btn-block btn-primary">Enviar mis requisitos</a>
								</div>
							</div>
							...
							<div class="card">	
								<div class="card-body">
									<div class="media">
									  ...
									  <div class="media-body">
											<a href="hhttp://rduque.com/plan-de-marketing/" title="Crear mi plan de marketing" class="nav-link">
									    	<h2>Plan de marketing</h2>
											</a>
								    	<p class="ml-3">Definamos juntos el mejor camino a seguir para llegar a tu público objetivo</p>
									  </div>
									</div>
								</div>
								
								<div class="card-footer text-right">
								    	<a href="http://rduque.com/plan-de-marketing/" title="Clic aquí para comenzar" class="btn btn-block btn-primary">Enviar requisitos</a>
								</div>
							</div>
