<div class="row">
	<div class="col-xs-12 col-md-3">
		...
		<div class="card">	
			...
			<div class="card-footer text-right">
			    	<a href="http://rduque.com/contacto/" title="Clic aquí para comenzar" class="btn btn-block btn-secondary">Solicitar asesoramiento</a>
			</div>
		</div>
	...
	<div class="col-xs-12 col-md-3">	
		...
		<div class="card">	
			...
			<div class="card-footer text-right">
			    	<a href="http://rduque.com/swiip/" title="Clic aquí para comenzar" class="btn btn-block btn-secondary">Enviar mis requisitos</a>
			</div>
		</div>
	...
	<div class="col-xs-12 col-md-3">	
		...
		<div class="card">	
			...
			<div class="card-footer text-right">
		    <a href="http://rduque.com/crear-blog-web-empresa/" title="Clic aquí para enviarnos un pliego con tus requisitos" class="btn btn-block btn-secondary">Enviar mis requisitos</a>
			</div>
		</div>
	...
	<div class="col-xs-12 col-md-3">	
		...
		<div class="card">	
			...
			<div class="card-footer text-right">
		    <a href="http://rduque.com/crear-una-tienda-online/" title="Empezar a crear mi tienda online" class="btn btn-block btn-secondary">Enviar mis requisitos</a>
			</div>
		</div>
